            ...
            <div class="row">
                <div class="col-lg-4 m-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                    <form method="POST" action="{{ route('homelogoupdatepost', $info->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                          <label for="exampleInputEmail1">Logo</label>
                          <input type="file" class="form-control" name="logo">
                        </div>
                        <img style="height: 20px; width: 30px;" src="{{ asset('uploads/logo') }}/{{ $info->logo }}" alt="">
                        <br>
                        <br>
